...
public class MockWebServer {
	...
	public void start(boolean shouldJoin){
        ...
        context.addServlet(LoginServlet.class, "/api/auth/login");
        context.addServlet(DownloadServlet.class, "/api/business/monitor/SyncStatus/download/*");
        context.addServlet(UploadServlet.class, "/api/business/monitor/SyncStatus/upload/*");
